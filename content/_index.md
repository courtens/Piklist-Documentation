...
<ul id="features-table">
  ...
  <li class="feature">
    <h3><i class="fas fa-sitemap fa-sm"></i><a href="https://docs.piklist.com/tutorials/terms/">Taxonomies</a></h3> Register Taxonomies with Piklist and add power to your terms.
  </li>
  <li class="feature">
